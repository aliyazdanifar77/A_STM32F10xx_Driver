...
typedef struct
{
		  uint16_t Pin		:5;      	/*!< Specifies the GPIO pins to be configured.*/
		  uint16_t Mode     :3;		/*!< Specifies the operating mode for the selected pins.*/
		  uint16_t Speed	:2;     	/*!< Specifies the speed for the selected pins.*/
